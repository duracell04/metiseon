        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 border-t border-border pt-8">
            <p className="text-sm text-muted-foreground">
              All steps are deterministic. Given identical inputs and timestamps, the system produces identical outputs.
              No discretion, no optimization, no look-ahead bias.
            </p>
          </div>
        </div>
      </main>
